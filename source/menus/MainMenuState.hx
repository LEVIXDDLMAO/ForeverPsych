...
class MainMenuState extends MusicBeatState
{
	...
	public static var infEngineVersion:String = 'idgaf';
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "Forever Engine Legacy v" + Application.current.meta.get('version'), 12);
